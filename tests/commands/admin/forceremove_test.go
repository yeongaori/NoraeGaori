...
func TestForceRemove(t *testing.T) {
	...
	commandtest.Run(t, "forceremove", admin.HandleForceRemove, []commandtest.Case{
		{
...
func TestForceRemoveSplitsALongSummary(t *testing.T) {
	...
	if err := admin.HandleForceRemove(fixture.Session, ic); err != nil {
...
func TestRegisterAddsTheAdminCommands(t *testing.T) {
	admin.Register(func(string) messages.CommandStrings { return messages.CommandStrings{} })

	commandtest.WantRegistered(t, map[string]commandtest.Registration{
		"forceskip":   {Handler: admin.HandleForceSkip, IsAdminOnly: true},
		"forceremove": {Handler: admin.HandleForceRemove, IsAdminOnly: true},
		"forcestop":   {Handler: admin.HandleForceStop, IsAdminOnly: true},
		"status":      {Handler: admin.HandleStatus, IsAdminOnly: true},
	})
}
